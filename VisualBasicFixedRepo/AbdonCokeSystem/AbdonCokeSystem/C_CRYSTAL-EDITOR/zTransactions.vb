...
Public Class zTransactions
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AbdonCokeSystem.zTransactions.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedzTransactions
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As zTransactions = New zTransactions()
        rpt.Site = Me.Site
        Return rpt
    End Function
